...
//  V(RunTesting,                  BOOL,     "0"),
  ...
  V(SelectPathsWithTrust,             BOOL,     "0"),
  V(SelectPathsWithTrustOne,          BOOL,     "0"),
  V(SelectPathsWithTrustAll,          BOOL,     "0"),
  V(TrustPolicyTheMan,                BOOL,     "0"),
  V(TrustPolicyCountry,               BOOL,     "0"),
  V(TrustClientsFile,                 STRING,   NULL),
  V(TrustGuardsFile,                  STRING,   NULL),
  V(TrustExitsFile,                   STRING,   NULL),
  V(TrustServersFile,                 STRING,   NULL),
  V(TrustScoresFile,                  STRING,   NULL),
  V(TrustAdvsInFile,                  STRING,   NULL),
  V(TrustAdvsOutFile,                 STRING,   NULL),
  V(TrustCountriesFile,               STRING,   NULL),
  V(TrustMinBWWeightFraction,         DOUBLE,   "0.15"),
  V(TrustMinBWWeightFractionGuard,    DOUBLE,   "0.0"),
  V(TrustRelayFamilyUncompProb,       DOUBLE,   "0.9"),
  V(TrustASORGUncompProb,             DOUBLE,   "0.9"),
  V(TrustIXPORGUncompProb,            DOUBLE,   "0.9"),
  V(TrustSafeGuardUncompThresh,       DOUBLE,   "0.95"),
  V(TrustSafeGuardCompThresh,         DOUBLE,   "2.0"),
  V(TrustSafeExitUncompThresh,        DOUBLE,   "0.95"),
  V(TrustSafeExitCompThresh,          DOUBLE,   "2.0"),
  V(TrustAcceptableGuardUncompThresh, DOUBLE,   "0.5"),
  V(TrustAcceptableGuardCompThresh,   DOUBLE,   "5.0"),
  V(TrustAcceptableExitUncompThresh,  DOUBLE,   "0.5"),
  V(TrustAcceptableExitCompThresh,    DOUBLE,   "5.0"),
